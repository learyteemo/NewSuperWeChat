...
public class EaseUserUtils {
    ...
    public static void setCurrentweixinhapuserName(TextView textView) {
        String username = EMClient.getInstance().getCurrentUser();
        setAppUserName("",username,textView);
    }

    public static void setAppUserNamewithno(String mUserName, TextView mtvWeixinhao) {
        setAppUserName("",mUserName,mtvWeixinhao);
    }
